                        ...
                        <div className="row mx-auto">
                            <div style={{ fontSize: '80%' }} className="card border p-0 col-11 col-md-12 col-xl-11">
                                ...
                                <div className="card-body p-4">
                                    ...
                                    <div className="row d-flex font-weight-bold pt-2 justify-content-between p-0">
                                        <div >Creator	</div>
                                        <div className="ml-auto text-white" > <div className="ml-auto text-white" ><a href={`https://bscscan.com/address/${challenge[0].challenge.payload.creator}`} target="_blank"> {challenge[0].challenge.payload.creator.replace(/(.{15})..+/, "$1…")} <i className="fa-solid fa-arrow-up-right-from-square"></i> </a></div></div>
                                    </div>
                                    {/* <div className="row d-flex font-weight-bold pt-2 justify-content-between p-0">
                                        <div >Network</div>
