            ...
            <div className="section">
                    ...
                    <div className="faq-list">
                            ...
                            <div className="faq-body">
                                <div className="faq-text">
                                    <a href="https://pancakeswap.finance/swap">
                                        https://pancakeswap.finance/swap </a> MetaMask & TrustWallet - *MetaMask
                                    most
                                    recommended*
                        ...
                        <div className="faq">
                            ...
                            <div className="faq-body">
                                <div className="faq-text">
                                    ...
                                    <p>4. Go to <a
                                        href="https://pancakeswap.finance/swap">https://pancakeswap.finance/swap</a>
                                    </p>
                                    ...
                                    <p>6. The "from" is BNB and "to" is the SOSX token contract <a
                                        ...
                                        (https://bscscan.com/token/0xee52def4a2683e68ba8aecda8219004c4af376df)
                                    </a> can be
                        ...
                        <div className="faq">
                            ...
                            <div className="faq-body">
                                <div className="faq-text">
                                    Yes, anyone can record themselves for the challenge videos. But to participate
                                    in the
                                    challenge
                            ...
                            <div className="faq-body">
                                <div className="faq-text">
                                    ...
                                    <a
                                        ...
                                        https://app.unicrypt.network/amm/pancake-v2/pair/0x31550eb6b4628ad83ee71ca1a05df4a40f622ba6
                                    </a>
                                </div>
                            </div>
                        </div>
