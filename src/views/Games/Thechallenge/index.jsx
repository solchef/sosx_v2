...
// 						<div className="row">
// 							<div className="card3 col-12 col-lg-6 col-6 rounded-0 d-flex flex-column justify-content-between align-items-start">

							
// 									<div className="feature-box">
// 										<div className="feature-icon mobile-hide-card ">
// 											<img src="images/prize-pool-icon.png" style={{width: '50px' , height:'50px' }} />
// 										</div>
...
// 									<div className="feature-box">
// 										<div className="feature-icon mobile-hide-card ">
// 											<img src="images/submission-date-icon.png" style={{ width: '50px' , height:'50px' }} />
// 										</div>
// 										<div className="feature-text">
...
// 							</div>
// 							<div className=" p-0 col-12  col-lg-6 rounded-0 d-flex flex-column justify-content-between card3 overflow-hidden">
