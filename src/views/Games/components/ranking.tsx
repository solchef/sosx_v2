...
const Ranking = (props) => {
  ...
  return (
    ...
    //   <button onClick={() => setDisplayLevel(1)} type="submit" className={`font-weight-bold btn  text-nowrap ${displayLevel === 1 ?' btn-primary':''}`}
    //   > Level 1</button>
            ...
            <div className="card h-100 w-100" style={{minHeight: "500px"}}>
                <div className="d-flex align-items-center mb-2">
                  {/* <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        viewBox="0 0 239 116"
                        style="enable-background:new 0 0 239 116;width:40px;fill: #ff00cc;margin-right: 10px;"
                        xml:space="preserve">
                ...
                <p>To become member, visit <a href="/daostaking/">STAKING DAO</a></p>
                <div className="d-flex justify-content-between mt-3">
                <button type="submit" onClick={() => setDisplayLevel(1)}  className={`font-weight-bold btn  text-nowrap ${displayLevel === 1 ?' btn-primary':''}`}> Level 1</button>
                <button type="submit" onClick={() => setDisplayLevel(2)} className={`font-weight-bold btn  text-nowrap ${displayLevel === 2 ?' btn-primary':''}`}> Level 2</button>
                <button type="submit" onClick={() => setDisplayLevel(3)} className={`font-weight-bold btn  text-nowrap ${displayLevel === 3 ?' btn-primary':''}`}> Level 3</button>
               </div>
