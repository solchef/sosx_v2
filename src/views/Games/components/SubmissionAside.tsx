...
export const  SubmissionAside = () => {
    ...
    <div id="timer-section" style={{flex: '350px'}}>
        <div className="card timer-card mb-3">
          ...
          <div className="d-flex align-items-center">
            <h4 className="subtitle">SUBMIT YOUR VIDEO</h4>
          </div>
          <div className="d-flex align-items-center">
            <h5 className="subtitle">ANYONE WHO WANTS TO GET PAID</h5>
          </div>
          <p className="mt-3">The first successful submission that follows all rules wins the prize pool. Video must
            be uploaded to youtube or TikTok prior.</p>
          <div className="d-flex align-items-center mt-4 mb-2"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 239 116" xmlSpace="preserve" style={{width: '40px', fill: 'rgb(255, 0, 204)', marginRight: '5px'}}>
              <path d="M58,0C25.97,0,0,25.97,0,58c0,32.03,25.97,58,58,58s58-25.97,58-58C116,25.97,90.03,0,58,0z M58,90.78 c-18.11,0-32.78-14.68-32.78-32.78c0-18.11,14.68-32.78,32.78-32.78S90.78,39.89,90.78,58C90.78,76.11,76.11,90.78,58,90.78z">
              </path>
              <g>
                <path className="st0" d="M151.87,48.3l-25.23-25.23c-5.27-5.27-5.27-13.82,0-19.09l0,0c5.27-5.27,13.82-5.27,19.09,0l25.23,25.23 c5.27,5.27,5.27,13.82,0,19.09l0,0C165.69,53.57,157.14,53.57,151.87,48.3z">
          ...
          <p style={{fontWeight: 800, color: 'white'}}>1 - You must say in the video, "SocialX paid me to do it."
          </p>
          <p style={{fontWeight: 800, color: 'white'}}>2 - Socialx.io URL must be mentioned in the info section of
            hosted video</p>
          <p style={{fontWeight: 800, color: 'white'}}>3 - Video must be shared on your social media.</p>
        </div>
        <div className="card timer-card mb-3">
          <div className="d-flex align-items-center mb-2"><img src="images/submission-date-icon.png" className="title-icon" />
            <h4>NO TIMER</h4>
          </div>
          <p>Challenge is up until winner. First one to complete the challenge wins</p>
