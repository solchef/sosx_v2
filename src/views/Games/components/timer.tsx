  ...
  return (
    ...
    {props.stage == 2 && (
         ...
         <div className="card rules-card">
           ...
           <p className="mt-3">It's time to vote for the next game challenge. The top 3 challenges with the most votes
             will move forward to the final vote on stage 3. </p>
           <p>Review all the challenges to the right. For full descriptions, tap the DETAILS tab.</p>
