    ...
    <>
      ...
      {props.stage != 4 ? (
        ...
        <div className="card timer-card mb-3 mt-3">
          ...
          <p>
            Challenge is up until winner. First one to complete the challenge
            wins
          </p>
          <div className="clock mt-4">
            <div
      ...
      {props.stage == 3 && (
        <div className="card rules-card">
          ...
          <p className="mt-3">
            Here are the top 3 challenges with the most votes and it's up to you
            fellow DAOX Members to decide which challenge will make it to the
            game.{" "}
          </p>
          <p>
            Review all 3 the challenges to the right. For full descriptions, tap
            the VIEW tab.
          </p>
          <p>
            Place your one vote only by tapping the VOTE button. Vote cannot be
            reversed.
          </p>
        </div>
      )}
      ...
      {props.stage == 4 && (
        <div className="card timer-card mb-3">
          ...
          <p className="mt-3">
            The first successful submission that follows all rules wins the
            prize pool. Video must be uploaded to youtube or TikTok prior.
          </p>
          <div className="d-flex align-items-center mt-4 mb-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <p style={{ fontWeight: 800, color: "white" }}>
            1 - You must say in the video, "SocialX paid me to do it."
          </p>
          <p style={{ fontWeight: 800, color: "white" }}>
            2 - Socialx.io URL must be mentioned in the info section of hosted
            video
          </p>
          <p style={{ fontWeight: 800, color: "white" }}>
            3 - Video must be shared on your social media.
          </p>
        </div>
      )}
