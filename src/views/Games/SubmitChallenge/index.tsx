...
const Submission = (props: {level, stage}) => {
  ...
  const videoLink = async (evt: FormEvent<HTMLFormElement>) => {
    ...
    <div className="d-flex align-items-center mb-2"><svg xmlns="http://www.w3.org/2000/svg" 
            xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px"
            viewBox="0 0 239 116" xmlSpace="preserve"
            style={{width: '80px', fill: 'rgb(255, 0, 204)', marginRight: '5px'}}>
            <path
    ...
    <p>Create a video accomplishing described challenge bellow for a chance to win prize pool</p>
    <div className="mt-5 d-flex flex-row flex-wrap">
        ...
        <form onSubmit={videoLink}>
            ...
            <button className="btn btn-primary btn-lg mt-5 mb-5 " type="submit"
                style={{width: 'max-content'}}>SUBMIT VIDEO LINK</button>
