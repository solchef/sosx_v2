...
export default function UserStakingLogs(props) {
  ...
  return (
    <div style={{ padding: "15px" }} className="card d-flex flex-column h-100">
      <div className="card-header p-0">
        <div style={{ flex: "2 auto" }}>
          ...
          <p className=" mb-0">Your Staking Activities</p>
        </div>
        <div style={{ flex: "0 120px" }}>
          <button
            className="btn mr-1 w-100 btn-primary pt-3 pb-3 btn-lg mt-2"
            type="button"
        ...
        <table className=" fs-12 p-4 mt-0 table " style={{ maxWidth: "100%" }}>
          ...
          <tbody>
            {activeStakes.map((stake, i) => (
              <tr style={{ borderColor: "rgb(30, 33, 36)" }}>
                ...
                <td className=" text-left"> {stake.amount}</td>
              </tr>
            ))}
          </tbody>
        </table>
