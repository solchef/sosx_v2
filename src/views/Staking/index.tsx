        ...
        <div className="row mobile-hide">
            <div className="col-sm-3">
                <div className="card overflow-hidden ">
                    <div className="card-header align-items-start border-0">
                        <div>
                            <h4 className="fs-24 mb-0">10,000,000,000</h4>
                            <span className="fs-12">Total supply</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className="col-sm-3">
                <div className="card overflow-hidden">
                    <div className="card-header align-items-start border-0">
                        <div>
                            <h4 className="fs-24 mb-0">$() </h4>
                            <span className="fs-12">Market Cap</span>
                        </div>
            ...
            <div className="col-sm-3">
                <div className="card overflow-hidden">
                    <div className="card-header align-items-start border-0 justify-content-between">
                        <div>
                            <h4 className="fs-24 mb-0">3183</h4>
                            <span className="fs-12">Holders</span>
                        </div>
							...
							<div className="card-body">
                                <div className="bg-dark mb-3 p-3 rounded">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <span>
                                            {/* <input type="text" className="form-control" placeholder="0.00" maxlength="25"
                                                value=""/> */}
								...
								<div className="bg-dark p-3 rounded">
									<div className="d-flex justify-content-between">
										...
										<div className="small2">
											...
											<div className="d-flex align-items-center">
												<div className="text-white fs-14"> {(Number(amountToStake) * (stakingClass == 1 ? 3 : stakingClass == 2 ? 64 : 145))} SOSX</div>
											</div>
										</div>
									</div>
								</div>
...
<div className="col-xl-6">
     <div className="card">
            ...
            <p className="success mb-0 fs-12">Total SOSX Staked</p>
                    ...
                    <h4 className="mb-0 font-w600  fs-24 pb-2">
                    {hasReferral ? (
                         hasReferral
                            ) : (
                                <b> No</b>
                ...
                {/* <button type="button" className="btn btn-primary btn-lg w-100 mt-4">Claim Rewards</button> */}
            </div>


                 <div className="card-footer">
                    <div className="progress">
                    <div className="progress-bar bg-success" aria-valuenow={0} aria-valuemin={0} aria-valuemax={100} style={{width: '0%', height: '30px'}} role="progressbar progress-text" >
                            
                    </div>
                  
                </div>
                {/* <small style={{marginTop:"-30%"}}>*Earliest unstake</small> */}
               ...
               <div className="card-header border-0 pb-0">
                   ...
                   <div className="token-balance-icon mb-3">
                       <img src="data:image/png;base64,"
                           alt="logo" className="sosx-img"/></div> </div>
                           <div col-9>		
               ...
               <div className="card-body">
                   ...
                   {console.log(stakingList)}
                        ...
                        {stakingList.length == 0 ? (
                                    <>
								<span className="fs-14">Staking Entry</span>
