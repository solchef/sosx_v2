							...
							{stakingList.length == 0 ? (
								<>
									...
									<ul className="token-balance-list mb-2 mt-2">
										<li><span className="justify-content-between text-success fs-12">Duration</span></li>
										<li><span className="text-success fs-12">Amount</span></li>
									</ul>
