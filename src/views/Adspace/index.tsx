    ...
    <div className="container-fluid mt-5">
      ...
      <div className="row ">
        {adspaceData.map((data, index) => {
          return (
            <div key={index} className="col-xl-4 col-lg-6 mb-2 mt-2">
              <div
                style={
              ...
              >
                ...
                <div className="card align-items-center d-flex justify-content-between">
                  ...
                  <a href={data.sharedUrl}>
                    <button
                      type="button"
                      className="btn text-nowrap ml-2 btn-primary"
                    >
                      {" "}
                      Visit Website
                    </button>
      ...
      <Modal show={viewInfoModle} centered>
        ...
        >
          <div className="d-flex flex-column">
            <div className="title-pink custom-pt mb-5 d-flex flex-column justify-content-center align-items-center">
              <img width="50%" src={selectedData.image}></img>
