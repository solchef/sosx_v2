  ...
  return (
    <>
      <div
        ...
        style={{ flex: "1 1 25%", order: "2", maxWidth: "100%" }}
      >
        <div className="card h-100">
          <div className="card-body">
            <div className="flex-column flex-sm-row d-flex justify-content-between w-100 ml-auto mr-0 align-items-sm-center">
              <div className=" d-flex flex-sm-column justify-content-between aligin-items-center pr-1">
                <h4 className="d-flex align-items-center align-items-sm-start">
                  {" "}
                  <svg
              ...
              <div className="d-flex flex-sm-column justify-content-between aligin-items-center">
                <h4 className="d-flex align-items-center align-items-sm-start">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      <div
        className="text-nowrap"
        style={{ flex: "1 1 25%", order: "3", maxWidth: "100%" }}
      >
        <div className="card h-100">
          <div className="card-body">
            <div className="flex-column flex-sm-row d-flex justify-content-between w-100 ml-auto mr-0 align-items-sm-center">
      ...
      <div
        className="text-nowrap"
        style={{ flex: "1 1 25%", order: "4", maxWidth: "100%" }}
      >
        <div className="card h-100">
          <div className="card-body">
            <div className="flex-column flex-sm-row d-flex justify-content-between w-100 ml-auto mr-0 align-items-sm-center">
