const Header = ({ referralCount, viewReferralReward }) => {
    return (
        <>
            <div className="text-nowrap " style={{ flex: '1 1 25%',order:'2', maxWidth: '100%' }}>
            ...
            <div className="text-nowrap" style={{ flex: '1 1 25%',order:'3', maxWidth: '100%' }}>
                <div className="card h-100">
                    <div className="card-body">
                        <div className="flex-row d-flex justify-content-between w-100 ml-auto mr-0 align-items-center">
                            <div className="border-right pr-1">
            ...
            <div className="text-nowrap" style={{ flex: '1 1 25%',order:'4', maxWidth: '100%' }}>
                <div className="card h-100">
                    <div className="card-body">
                        <div className="flex-row d-flex justify-content-between w-100 ml-auto mr-0 align-items-center">
                            <div className="border-right pr-1">
